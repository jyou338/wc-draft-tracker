...
export const results: Result[] = [
  ...
  },
  {
    ...
    scoreFor: 4,
    scoreAgainst: 1,
    goals: ["Erling Haaland","Erling Haaland","Leo Østigard","OG (Aymen Hussein)"],
    assists: 2,
    cleanSheet: false,
    yellowCards: [],
    redCards: [],
...
export const lastUpdated = "2026-06-17 01:28 UTC";
...
export const liveMatches: LiveMatch[] = [
  { team: "Argentina", opponent: "Algeria", scoreFor: 1, scoreAgainst: 0, minute: "26'" },
];
